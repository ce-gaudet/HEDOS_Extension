...
from utils.alc_analysis import run_alc_analysis
...
RD1_name = os.path.splitext(os.path.basename(RD1))[0]
RD2_name = os.path.splitext(os.path.basename(RD2))[0]
...
def run_pipeline(PATIENT, PLANS, SIMULATION):
    ...
    print("\nRunning ALC analysis...")

    run_alc_analysis(
        f"results/blood_dose/{RD1_name}/all_runs.npy",
        f"results/blood_dose/{RD2_name}/all_runs.npy",
    )
